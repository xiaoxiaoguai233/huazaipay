...
@Service
public class JiujiuliuPayNotifyService extends BasePayNotify {
    private static final MyLog _log = MyLog.getLog(JiujiuliuPayNotifyService.class);
    ...
    public JSONObject doNotify(Object notifyData) {
        String logPrefix = "【处理996支付回调】";
        _log.info("====== 开始处理996支付回调通知 ======");
        HttpServletRequest request = (HttpServletRequest) notifyData;
        String retJsonStr = Util.JsonReq(request);//返回的json
        JSONObject retObj = buildRetObj();
        Map<String, Object> payContext = new HashMap<String, Object>();
        String respString = JiujiuliuConfig.RETURN_VALUE_FAIL;
        try {
            JSONObject params = JSONObject.parseObject(retJsonStr);
            payContext.put("parameters", params);
            if (!verifyPayParams(payContext)) {
                retObj.put(PayConstant.RESPONSE_RESULT, JiujiuliuConfig.RETURN_VALUE_FAIL);
                return retObj;
            }
            ...
            _log.info("====== 完成处理996支付回调通知 ======");
            respString = JiujiuliuConfig.RETURN_VALUE_SUCCESS;
        } catch (Exception e) {
    ...
    public boolean verifyPayParams(Map<String, Object> payContext) {
        ...
        // 校验结果是否成功
//        Object trade_no = params.get("trade_no");
        Object total_fee = params.get("total_fee");
        Object out_trade_no = params.get("out_trade_no");
//        Object tradingfee = params.get("tradingfee");
//        Object paysucessdate = params.get("paysucessdate");
        ...
        String validSign = getMd5Sign(signParam, APP_KEY).toLowerCase();
        ...
        // 核对金额
        long outPayAmt = new BigDecimal(total_fee.toString()).multiply(new BigDecimal("100")).longValue();
    ...
    static String getMd5Sign(TreeMap<String, String> signParam, String app_key) {
        ...
        String s = "";
        try {
            s = Util.md5(stringBuffer.toString()).toUpperCase();
