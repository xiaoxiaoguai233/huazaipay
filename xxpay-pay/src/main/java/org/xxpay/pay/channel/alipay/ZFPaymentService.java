...
@Service
public class ZFPaymentService  extends BasePayment {

    private static final MyLog _log = MyLog.getLog(SsskmPaymentService.class);
    public final static String PAY_CHANNEL_ZF_ALIPAY_SC = "zf_alipay_sc";	            // 支付宝当面付之H5支付
    ...
    public JSONObject pay(PayOrder payOrder) throws Exception {
        ...
        switch (channelId) {
            case PAY_CHANNEL_ZF_ALIPAY_SC :                  // 支付宝APP - SLRJ
                retObj = doAliPaySCZFReq(payOrder);
                break;
        }
        return retObj;
    }
     ...
     * @return
     */
    public JSONObject doAliPaySCZFReq(PayOrder payOrder) throws Exception {

        String logPrefix = "【8026-京东直付-京东E卡-8026】";
        ...
        payParams.put("payUrl", "http://pay.astro99.top/api/ssskm/" + payOrder.getPayOrderId());
