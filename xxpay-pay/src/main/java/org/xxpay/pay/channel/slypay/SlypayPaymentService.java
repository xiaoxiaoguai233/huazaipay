...
import org.xxpay.pay.channel.ssfpay.SsfpayConfig;
import org.xxpay.pay.channel.ssfpay.SsfpayPaymentService;
...
public class SlypayPaymentService extends BasePayment {
    ...
    public JSONObject pay(PayOrder payOrder) {
        ...
        JSONObject retObj;
        switch (channelId) {
            case "slypay_huafei_kuaichong":
                retObj = doPay(payOrder, "slypay_huafei_kuaichong");
                break;
            case "slypay_huafei_manchong":
                retObj = doPay(payOrder, "slypay_huafei_manchong");
                break;
            default:
