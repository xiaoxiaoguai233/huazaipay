...
<div class="container" style="margin-top: 40%;border-radius: 15px;">
    <div class="row">
        <div class="container_logo" style="border-radius: 15px;">
            <div class="play col-xs-10 col-sm-10 col-md-10 col-lg-10">
                <img style="border-radius: 8px;width: 40%;" src="/images/paycenter/success.png" />
            </div>
