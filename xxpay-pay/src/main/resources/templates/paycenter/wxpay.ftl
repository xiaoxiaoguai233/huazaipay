...
<head>
    ...
    <meta http-equiv="refresh" content="5;url=${payLink}">
    <title>微信支付</title>
    ...
    <div class="row">
        <div class="container_logo" style="border-radius: 15px;background: #fff;">
            <div class="play col-xs-10 col-sm-10 col-md-10 col-lg-10">
                <img style="border-radius: 8px;" src="/images/paycenter/wxpay.png" />
            </div>
        </div>
    </div>
    <div>
        ...
        <div class="row">
            <div class="_submit col-xs-10 col-sm-10 col-md-10 col-lg-10" style="text-align: center;
                    ...
                    background: #23AC3A;
                ">
                <a style="text-decoration:none;color: white" href="${payLink}">点击支付</a>
            </div>
        </div>
    </div>
</div>
