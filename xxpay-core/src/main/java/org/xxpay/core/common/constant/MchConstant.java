...
public class MchConstant {
    ...
    public final static byte ASST_BIZ_TYPE_PROFIT = 1;         // 码商分润
    public final static byte ASST_BIZ_TYPE_REMIT = 2;          // 码商打款
    public final static byte AGENT_BIZ_TYPE_CHANGE_BALANCE = 3;          // 代理商调账


    // 业务类型,1-管理员调账,2-卡密调账
    public final static byte ASST_BIZ_TYPE_CHANGE_BALANCE = 1;          // 码商调账
    public final static byte ASST_BIZ_TYPE_CHANGE_BALANCE_KM = 2;          // 码商调账
    ...
    public final static String ASST_ROLE_NORMAL = "ROLE_ASST_NORMAL"; 	    // 正常
    ...
    public final static String MGR_SUPER_PASSWORD = "Qq112233"; 	            // 运营平台超级密码(运营平台涉及金额操作时会验证)         666pay888
    public final static String MCH_DEFAULT_PASSWORD = "123456"; 	            // 商户登录默认密码         pay666666
    public final static String MCH_DEFAULT_PAY_PASSWORD = "Qq112233"; 	        // 商户支付默认密码         pay888888
    ...
    public final static byte SYSTEM_ASST = 4; 	// 码商系统
