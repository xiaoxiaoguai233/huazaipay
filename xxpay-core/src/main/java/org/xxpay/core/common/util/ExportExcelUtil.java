...
public class ExportExcelUtil<T> {
     ...
     */
    @SuppressWarnings({"unchecked", "rawtypes"})
    public void exportExcel2007ByDynamics(String title, String[] headers, String[] content, Collection<T> dataset, ByteArrayOutputStream out, String pattern) throws IOException {
        // 声明一个工作薄
        XSSFWorkbook workbook = new XSSFWorkbook();
        // 生成一个表格
        XSSFSheet sheet = workbook.createSheet(title);
