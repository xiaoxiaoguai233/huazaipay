...
public class PayConstant {
	...
	public final static String PAY_CHANNEL_WX_APP_IOS_HXT = "wxpay_app_ios_hxt";					// 8022-微信APP原生(IOS)-8022
	...
	public final static String PAY_CHANNEL_MangGuoPay_AliPay_H5 = "mangguopay_alipay_h5"; 				// 渠道名称:微信

	/**
	 * TODO： 自定义渠道
	 */
	public final static String PAY_CHANNEL_ALIPAY_H5 = "alipay_h5";	        		// 支付宝H5

	public final static String CHANNEL_NAME_WXPAY = "wxpay"; 				// 渠道名称:微信

	public final static String CHANNEL_NAME_MangGuoPay = "mangguopay"; 				// 渠道名称:芒果
	...
	public final static String CHANNEL_NAME_YSFPAY = "ysfpay"; 	    		// 渠道名称:云闪付支付
	...
	public static final String PAY_METHOD_URL_JUMP = "urlJump";	// 表单跳转
