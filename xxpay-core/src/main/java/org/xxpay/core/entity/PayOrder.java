...
public class PayOrder implements Serializable {
    ...
    public void setSubMchId(Long subMchId) {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getPayOrderId() == null ? other.getPayOrderId() == null : this.getPayOrderId().equals(other.getPayOrderId()))
            ...
            && (this.getCardPwd() == null ? other.getCardPwd() == null : this.getCardPwd().equals(other.getCardPwd()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCardPwd() == null) ? 0 : getCardPwd().hashCode());
        return result;
    }
}