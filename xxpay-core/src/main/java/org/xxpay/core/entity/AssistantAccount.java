...
public class AssistantAccount  implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getAssistantId() == null ? other.getAgentId() == null : this.getAssistantId().equals(other.getAgentId()))
