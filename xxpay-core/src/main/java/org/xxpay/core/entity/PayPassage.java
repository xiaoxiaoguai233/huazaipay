...
public class PayPassage implements Serializable {
    ...
    /**
     * 金额类型 1 连续金额 2 固定金额 3 10的倍数 4 100的倍数
     *
     * @mbggenerated
     */
    ...
    public String toString() {
        ...
        sb.append(", fixAmount=").append(fixAmount);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getFixAmount() == null ? other.getFixAmount() == null : this.getFixAmount().equals(other.getFixAmount()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getFixAmount() == null) ? 0 : getFixAmount().hashCode());
