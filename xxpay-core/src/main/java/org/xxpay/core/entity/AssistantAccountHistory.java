...
public class AssistantAccountHistory implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        AssistantAccountHistory other = (AssistantAccountHistory) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                && (this.getAssistantId() == null ? other.getAssistantId() == null : this.getAssistantId().equals(other.getAssistantId()))
