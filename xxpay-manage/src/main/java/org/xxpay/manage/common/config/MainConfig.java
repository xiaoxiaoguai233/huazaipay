...
public class MainConfig {
	...
	public String getLoginAssistantUrl() {
		return loginAssistantUrl;
	}

	public void setLoginAssistantUrl(String loginAssistantUrl) {
		this.loginAssistantUrl = loginAssistantUrl;
	}

	private String loginAssistantUrl;
