...
//        String returnUrl = request.getParameter("returnUrl");
        ...
        // TODO FIX: 报空指针异常: 需要填写收银台
        CashierConfig cashierConfig = rpcCommonService.rpcCashierConfigService.get(mchInfo.getMchId());

        JSONObject retObj = createPayOrder(type, mchInfo.getMchId(), mchInfo.getPrivateKey(), appId, productId, amountB.toString(), subject, body, cashierConfig.getCallbackUrl(), cashierConfig.getReturnUrl(), extra);
        if (retObj == null) {
        ...
        if ("SUCCESS".equals(retObj.get("retCode"))) {
            ...
            if (checkSign.equals(retSign)) {
                ...
                return ResponseEntity.ok(new BizResponse(10001, retObj.getString("retMsg")));
            }
        }
