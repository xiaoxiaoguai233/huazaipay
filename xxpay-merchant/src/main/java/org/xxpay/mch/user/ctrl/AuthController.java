...
//        }
    ...
    public ResponseEntity<?>  getSiteTitle(HttpServletRequest request, HttpServletResponse response) throws IOException {
        JSONObject jsonObject = new JSONObject();

        jsonObject.put("siteTitle", "华仔支付");
        jsonObject.put("siteLogo", "http://127.0.0.11:8191/x_mch/start/layui/images/imgs/mch.png");
        jsonObject.put("siteIcon", "https://manage.slypay.top/imgs/b205ebda-f131-4833-9197-3c92c58a65dc.png");
        jsonObject.put("copyRight", "Copyright © HZPAY 2022");
        jsonObject.put("mainAdvert", "华仔支付");
        jsonObject.put("subAdvert", "老牌三方支付【 24H】交易/下发");
        jsonObject.put("serviceTel", "Telegram：");
        jsonObject.put("serviceQQ", "Telegram频道：https://t.me/");
        jsonObject.put("statisticalCode", "");
