...
public class MainGen {
    ...
    public static final String THIS_MODULE_NAME = "xxpay-generator"; //当前项目名称

    public static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/xxpaydb?useUnicode=true&characterEncoding=UTF-8&serverTimezone=GMT%2B8";
    public static final String DB_USERNAME = "root";
    public static final String DB_PASSWORD = "123456";

    // 多个用,  拼接
    //public static final String TABLE_NAMES= "t_sys_entitlement,t_sys_role,t_sys_user,t_sys_user_auth";
    public static final String TABLE_NAMES= "t_z_7881_account";
...
//        gc.setServiceImplName("%sService");  //不生成 service接口；
        ...
        pc.setParent("org.xxpay.core");     //根目录
        pc.setEntity("generator.entity");        //实体目录
        pc.setMapper("generator.mapper");     //Mapper接口目录
        pc.setXml("generator.mapper");        //xml目录

        pc.setService("delete_delete");     // service目录  不需要，暂时删除
//        pc.setService("generator.service");     // service目录  不需要，暂时删除
        pc.setServiceImpl("generator.service");       // serviceImpl 目录
