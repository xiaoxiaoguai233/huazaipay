package org.xxpay.asst.order.ctrl;
...
public class PayOrderController extends BaseController {
    ...
    public ResponseEntity<?> get(HttpServletRequest request) {
        ...
        Long assistantId = getUser().getId();
        PayOrder queyrPayOrder = new PayOrder();
        queyrPayOrder.setPhone(String.valueOf(assistantId));
    ...
    public ResponseEntity<?> list(HttpServletRequest request) {
        ...
        payOrder.setPhone(String.valueOf(getUser().getId()));
        // 订单起止时间
    ...
    public ResponseEntity<?> count(HttpServletRequest request) {
        ...
        obj.put("successTotalAssistantProfit", successMap.get("totalAssistantProfit"));     // 成功代理商利润
