...
public class RedisUtil {
    ...
    public static void setList(String key, List<Object> language ){
        stringRedisTemplate.opsForList().rightPush(key, JSONObject.toJSONString(language));
    }
