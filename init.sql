...
# 初始化系统用户
INSERT INTO t_mgr_sys_user (userName, passWord, nickName, email, mobile, status, createUserId, lastPasswordResetTime, createTime, updateTime, isSuperAdmin) VALUES ('xxpaymgr', '$2a$10$kFafDqYtRcifYbXujyzxnetsKJAQw5oofIYzugwWD34aQmrp3/AN6', '超级管理员', 'xxpay@126.com', '18866666666', 1, null, '2018-01-08 11:38:25', '2018-01-02 22:30:45', '2018-01-08 11:38:25', 1);
# 初始化系统资源
...
INSERT INTO t_pay_interface_type (IfTypeCode, IfTypeName, Status, Param, Remark, CreateTime, UpdateTime) VALUES ('sandpay', '杉德支付', 1, '[{"name":"mchId","desc":"商户ID","type":"text","verify":"required"},{"name":"publicKeyFile","desc":"公钥文件","type":"text","verify":"required"},{"name":"privateKeyFile", "desc":"私钥文件", "type": "text","verify":"required"},{"name":"password", "desc":"证书密码", "type": "text","verify":"required"},{"name":"reqUrl", "desc":"网关地址", "type": "text","verify":"required"}]', '杉德支付', '2018-05-09 18:16:53', '2018-05-09 18:16:53');
...
INSERT INTO t_pay_interface (IfCode, IfName, IfTypeCode, PayType, Scene, Status, Param, Remark, CreateTime, UpdateTime) VALUES ('sandpay_agentpay', '杉德代付', 'sandpay', '90', 3, 1, null, '', '2018-05-09 18:17:17', '2018-05-21 10:20:57');
